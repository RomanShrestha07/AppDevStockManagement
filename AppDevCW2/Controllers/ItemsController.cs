...
namespace AppDevCW2.Controllers
{
    public class ItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,itemName,itemCode,itemDescription,categoryId")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,itemName,itemCode,itemDescription,categoryId")] Item item)
        {
            if (id != item.id)
            {
                return NotFound();
