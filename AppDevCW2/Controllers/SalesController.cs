...
namespace AppDevCW2.Controllers
{
    public class SalesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,billNum,saleDate,customerId")] Sale sale)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,billNum,saleDate,customerId")] Sale sale)
        {
            if (id != sale.id)
            {
                return NotFound();
